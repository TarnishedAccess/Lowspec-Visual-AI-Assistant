...
# Your OpenAI API key IF you decide to use chatgpt as your model. Otherwise, head into chat.py and change whatever you need to change there.
API_KEY = ""
